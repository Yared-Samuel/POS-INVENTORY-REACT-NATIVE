...
const DetailSaleScreen = () => {
    ...
    const {saleServices}= useSelector((state)=>state.service);
...
const loadMoreData = () => {
  ...
  <ScrollView>
    ...
    <ScrollView style={{ marginHorizontal: 20 }}>
      ...
      {endIndex < sales.length && ( // Show "Load More" button if there's more data
...
export default DetailSaleScreen
